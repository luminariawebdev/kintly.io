...
import { ColorDot, USERLIST } from '../Components';

export function LoginScreen({ showError = false }) {
      ...
      <div className="fb-scroll">
        <div className="auth-wrap">
          ...
          <div className="auth-actions">
            <button className="fb-btn solid" onClick={() => setErr(true)}>Log in</button>
    ...
    <div className="fb-screen">
      <div className="fb-scroll">
        <div className="auth-wrap" style={{ paddingTop: 70 }}>
          ...
          <div className="auth-actions">
            <button className="fb-btn solid" onClick={() => setAccepted(true)}>Accept invite</button>
