// app.jsx — FamilyBoard wireframe canvas + Tweaks panel
...
function App() {
  // Tweak defaults come from the EDITMODE block in index.html so user edits
  // persist to disk via the host bridge.
  const [t, setTweak] = useTweaks(window.__FB_TWEAK_DEFAULTS || {
    shaderOn: true, shader: 'plasma', speed: 100, intensity: 100,
    alwaysOn: false, glow: true,
  });
